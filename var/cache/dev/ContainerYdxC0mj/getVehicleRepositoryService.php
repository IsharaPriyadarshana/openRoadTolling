...
// Returns the private 'App\Repository\VehicleRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/VehicleRepository.php';

return $this->privates['App\\Repository\\VehicleRepository'] = new \App\Repository\VehicleRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
