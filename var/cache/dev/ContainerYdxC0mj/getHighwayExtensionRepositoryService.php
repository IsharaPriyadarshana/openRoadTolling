...
// Returns the private 'App\Repository\HighwayExtensionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/HighwayExtensionRepository.php';

return $this->privates['App\\Repository\\HighwayExtensionRepository'] = new \App\Repository\HighwayExtensionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
