...
// Returns the private 'App\Repository\HighwayRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/HighwayRepository.php';

return $this->privates['App\\Repository\\HighwayRepository'] = new \App\Repository\HighwayRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
