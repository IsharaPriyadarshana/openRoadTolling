...
// Returns the private 'App\Repository\VehicleClassRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/VehicleClassRepository.php';

return $this->privates['App\\Repository\\VehicleClassRepository'] = new \App\Repository\VehicleClassRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
