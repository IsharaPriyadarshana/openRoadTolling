...
// Returns the private 'App\Repository\HighwayVehicleRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/HighwayVehicleRepository.php';

return $this->privates['App\\Repository\\HighwayVehicleRepository'] = new \App\Repository\HighwayVehicleRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
