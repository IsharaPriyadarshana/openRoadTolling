...
// Returns the private 'App\Security\MainAuthenticator' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Security/MainAuthenticator.php';

return $this->privates['App\\Security\\MainAuthenticator'] = new \App\Security\MainAuthenticator(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->services['router'] ?? $this->getRouterService()), ($this->services['security.csrf.token_manager'] ?? $this->load('getSecurity_Csrf_TokenManagerService.php')), ($this->services['security.password_encoder'] ?? $this->load('getSecurity_PasswordEncoderService.php')));
